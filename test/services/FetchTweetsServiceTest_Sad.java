...
/**
 * JUnit test cases for FetchTweetsServiceTest_Sad .
 *
 * @author Bitta
 * @version 1.0.0
 */

public class FetchTweetsServiceTest_Sad {
    ...
    public void setupData() {
        ...
        Twitterserver = Server.forRouter((components) -> RoutingDsl.fromComponents(components)
                ...
                .GET("/1.1/search/tweets.json").routeTo(() -> ok().sendResource("result_search_sad.json"))
                .build());
    ...
    /**
     * Verifies that the testFetchTweetsfromAPI returns correct response to the dummy input for sad emoticon
     */
    @Test
